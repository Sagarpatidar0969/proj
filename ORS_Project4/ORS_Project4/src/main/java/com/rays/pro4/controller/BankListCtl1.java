 ...
 * 
 */
@WebServlet(name = "BankListCtl1", urlPatterns = { "/ctl/BankListCtl1" })
public class BankListCtl1 extends BaseCtl{
	

	
	private static Logger log = Logger.getLogger(BankListCtl1.class);
...
//	        get the selected checkbox ids array for delete list
		...
		log.debug("BankListCtl1 doGet End");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.debug("BankListCtl1 doPost Start");
		System.out.println("BankListCtl1 doPost Start");
	...
	protected String getView() {
		return ORSView.BANK_LIST_VIEW1;
	}
