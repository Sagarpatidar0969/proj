...
@WebServlet(name = "BankCtl1", urlPatterns = { "/ctl/BankCtl1" })
public class BankCtl1 extends BaseCtl{
	...
	//	log.debug("BankCtl11 Method populatebean Started");
	...
	//	log.debug("BankCtl11 Method populatebean Ended");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//log.debug("BankCtl11 Method doGet Started");
	...
	//	log.debug("BankCtl11 Method doGet Ended");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//log.debug("BankCtl11 Method doPost Started");
		...
		if (OP_SAVE.equalsIgnoreCase(op) || OP_UPDATE.equalsIgnoreCase(op)) {
			...
			try {
				...
				ServletUtility.redirect(ORSView.BANK_CTL1, request, response);
				return;
			} catch (ApplicationException e) {
				//log.error(e);
				ServletUtility.handleException(e, request, response);
			...
			ServletUtility.redirect(ORSView.BANK_LIST_CTL1, request, response);
			return;
		}
		//log.debug("BankCtl11 Method doPostEnded");
		ServletUtility.forward(getView(), request, response);
