   ...
   <center>
           ...
           <input type="hidden" name="id" value="<%=bean.getId()%>">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="payment" placeholder="Enter Payment Type" size="25"  value="<%=DataUtility.getStringData(bean.getPaymentType())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="amount" placeholder="Enter amount" size="25" value="<%=DataUtility.getStringData(bean.getAmount())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                &nbsp;  &emsp;
                    <input type="submit" name="operation" value="<%=PaymentCtl.OP_UPDATE%>">
                      &nbsp;  &nbsp;
                    <input type="submit" name="operation" value="<%=PaymentCtl.OP_CANCEL%>"></td>
                ...
                &nbsp;  &emsp;
                    ...
                    &nbsp;  &nbsp;
                    <input type="submit" name="operation" value="<%=PaymentCtl.OP_RESET%>"></td>
